...
export const authComponents = {
    SignIn: {
        ...
        Footer() {
        const { tokens } = useTheme();
            return <View textAlign="center" padding={tokens.space.medium}>
                <p>&copy; Copyright MateSphere {year}. All rights reserved.</p>
            </View>
        },
    },
}
